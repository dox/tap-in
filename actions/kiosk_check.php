...
if ($staff->openShift()) {
	...
	echo '<button class="btn btn-danger btn-lg" onclick="performShiftAction(' . $staff->uid . ', \'end\')">' . icon('stop-fill', '1.5em') . ' End Shift (' . convertMinutesToHours($currentShift->totalMinutes()) . ')</button>';
} else {
